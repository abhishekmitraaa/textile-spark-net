  ...
  },
  {
    ...
    subCategories: [
      { id: "skincare", name: "Skincare", fields: [
        { id: "productType", label: "Product Type", type: "select", options: ["Moisturizer", "Serum", "Cleanser", "Toner", "Sunscreen", "Face Mask", "Exfoliator", "Eye Cream", "Face Oil", "Lip Balm"], required: true },
        { id: "skinType", label: "Skin Type", type: "multiselect", options: ["All Skin Types", "Oily", "Dry", "Combination", "Sensitive", "Normal", "Acne-Prone"], required: true, fullWidth: true },
        { id: "keyIngredients", label: "Key Ingredients", type: "multiselect", options: ["Hyaluronic Acid", "Retinol", "Vitamin C", "Niacinamide", "Salicylic Acid", "AHA/BHA", "Aloe Vera", "Tea Tree", "Turmeric", "Saffron"], fullWidth: true },
        ...
        { id: "concerns", label: "Skin Concerns", type: "multiselect", options: ["Anti-aging", "Acne", "Pigmentation", "Dark Circles", "Dullness", "Pores", "Hydration", "Sun Protection"], fullWidth: true },
      ]},
      { id: "makeup", name: "Makeup", fields: [
        { id: "productType", label: "Product Type", type: "select", options: ["Foundation", "Concealer", "Compact Powder", "Blush", "Bronzer", "Highlighter", "Primer", "Setting Spray", "BB Cream", "CC Cream"], required: true },
        { id: "finish", label: "Finish", type: "select", options: ["Matte", "Dewy", "Satin", "Natural", "Luminous", "Semi-Matte"] },
        { id: "coverage", label: "Coverage", type: "select", options: ["Sheer", "Light", "Medium", "Full", "Buildable"] },
        { id: "shadeRange", label: "Shade Range", type: "text", placeholder: "e.g., 20 shades, Fair to Deep" },
        { id: "formulation", label: "Formulation", type: "select", options: ["Liquid", "Cream", "Powder", "Stick", "Mousse", "Gel"] },
        { id: "skinType", label: "Best For", type: "multiselect", options: ["All Skin Types", "Oily", "Dry", "Combination", "Sensitive"], fullWidth: true },
      ]},
      { id: "lip-products", name: "Lip Products", fields: [
        { id: "productType", label: "Product Type", type: "select", options: ["Lipstick", "Lip Gloss", "Lip Liner", "Lip Tint", "Lip Crayon", "Liquid Lipstick", "Lip Balm", "Lip Scrub"], required: true },
        { id: "finish", label: "Finish", type: "select", options: ["Matte", "Glossy", "Satin", "Metallic", "Sheer", "Creamy"] },
        { id: "shadeRange", label: "Shade Range", type: "text", placeholder: "e.g., 30 shades" },
        { id: "longevity", label: "Longevity", type: "select", options: ["2-4 Hours", "4-6 Hours", "6-8 Hours", "8-12 Hours", "Transfer-proof"] },
        { id: "features", label: "Features", type: "multiselect", options: ["Hydrating", "Long-lasting", "Vegan", "Cruelty-free", "Paraben-free"], fullWidth: true },
      ]},
      { id: "eye-products", name: "Eye Products", fields: [
        { id: "productType", label: "Product Type", type: "select", options: ["Eyeshadow Palette", "Single Eyeshadow", "Eyeliner", "Mascara", "Eyebrow Pencil", "Eyebrow Gel", "False Lashes", "Eye Primer"], required: true },
        { id: "finish", label: "Finish", type: "select", options: ["Matte", "Shimmer", "Glitter", "Metallic", "Satin", "Duo-chrome"] },
        { id: "shadeCount", label: "Shades in Palette", type: "number", placeholder: "e.g., 12" },
        { id: "waterproof", label: "Waterproof", type: "select", options: ["Yes", "No", "Water-resistant"] },
        { id: "features", label: "Features", type: "multiselect", options: ["Smudge-proof", "Long-lasting", "Cruelty-free", "Vegan", "Hypoallergenic"], fullWidth: true },
      ]},
      { id: "haircare", name: "Haircare", fields: [
        { id: "productType", label: "Product Type", type: "select", options: ["Shampoo", "Conditioner", "Hair Oil", "Hair Mask", "Hair Serum", "Leave-in Conditioner", "Dry Shampoo", "Hair Spray", "Heat Protectant"], required: true },
        { id: "hairType", label: "Hair Type", type: "multiselect", options: ["All Hair Types", "Straight", "Wavy", "Curly", "Coily", "Fine", "Thick", "Color-treated"], required: true, fullWidth: true },
        { id: "concerns", label: "Hair Concerns", type: "multiselect", options: ["Hair Fall", "Dandruff", "Dryness", "Frizz", "Damage Repair", "Volume", "Growth", "Color Protection"], fullWidth: true },
        { id: "volume", label: "Volume", type: "text", placeholder: "e.g., 200ml, 300ml" },
        { id: "keyIngredients", label: "Key Ingredients", type: "multiselect", options: ["Keratin", "Argan Oil", "Biotin", "Coconut Oil", "Tea Tree", "Onion", "Bhringraj", "Amla"], fullWidth: true },
      ]},
      { id: "nail-products", name: "Nail Products", fields: [
        { id: "productType", label: "Product Type", type: "select", options: ["Nail Polish", "Gel Polish", "Base Coat", "Top Coat", "Nail Art Kit", "Nail Extensions", "Cuticle Oil", "Nail Remover"], required: true },
        { id: "finish", label: "Finish", type: "select", options: ["Glossy", "Matte", "Shimmer", "Glitter", "Metallic", "Chrome", "Holographic"] },
        ...
        { id: "features", label: "Features", type: "multiselect", options: ["Chip-resistant", "Long-lasting", "Vegan", "Non-toxic", "5-Free", "10-Free"], fullWidth: true },
      ]},
      { id: "fragrances", name: "Fragrances", fields: [
        { id: "productType", label: "Product Type", type: "select", options: ["Eau de Parfum", "Eau de Toilette", "Body Mist", "Perfume Oil", "Attar", "Deodorant", "Roll-on"], required: true },
        { id: "fragranceFamily", label: "Fragrance Family", type: "select", options: ["Floral", "Woody", "Oriental", "Fresh", "Citrus", "Musky", "Gourmand", "Aquatic"] },
        { id: "gender", label: "Gender", type: "select", options: ["Unisex", "Men", "Women"] },
        { id: "volume", label: "Volume", type: "text", placeholder: "e.g., 50ml, 100ml" },
      ...
      { id: "bath-body", name: "Bath & Body", fields: [
        { id: "productType", label: "Product Type", type: "select", options: ["Body Wash", "Body Lotion", "Body Butter", "Body Scrub", "Shower Gel", "Bath Bomb", "Hand Cream", "Body Oil", "Soap Bar"], required: true },
        { id: "skinType", label: "Skin Type", type: "multiselect", options: ["All Skin Types", "Dry", "Oily", "Sensitive", "Normal"], fullWidth: true },
        { id: "fragrance", label: "Fragrance", type: "text", placeholder: "e.g., Lavender, Rose, Unscented" },
        { id: "volume", label: "Volume / Weight", type: "text", placeholder: "e.g., 250ml, 200g" },
        { id: "features", label: "Features", type: "multiselect", options: ["Organic", "Vegan", "Paraben-free", "Sulphate-free", "Cruelty-free", "Handmade"], fullWidth: true },
      ]},
      { id: "beauty-tools", name: "Beauty Tools & Accessories", fields: [
        { id: "productType", label: "Product Type", type: "select", options: ["Makeup Brushes", "Brush Set", "Beauty Blender", "Eyelash Curler", "Tweezers", "Face Roller", "Gua Sha", "Derma Roller", "Mirror"], required: true },
        { id: "material", label: "Material", type: "select", options: ["Synthetic", "Natural Hair", "Silicone", "Stainless Steel", "Jade", "Rose Quartz", "Plastic"] },
        { id: "setSize", label: "Set Size (if applicable)", type: "select", options: ["Single", "3-piece", "5-piece", "7-piece", "10-piece", "12-piece", "15+"] },
        { id: "features", label: "Features", type: "multiselect", options: ["Cruelty-free", "Vegan", "Travel-friendly", "Professional Grade", "Ergonomic"], fullWidth: true },
      ]},
      { id: "mens-grooming", name: "Men's Grooming", fields: [
        { id: "productType", label: "Product Type", type: "select", options: ["Beard Oil", "Beard Balm", "Shaving Cream", "After Shave", "Face Wash", "Hair Wax", "Hair Gel", "Pomade", "Trimmer", "Grooming Kit"], required: true },
        { id: "skinType", label: "Skin Type", type: "multiselect", options: ["All Skin Types", "Oily", "Dry", "Sensitive", "Normal"], fullWidth: true },
        { id: "volume", label: "Volume / Weight", type: "text", placeholder: "e.g., 50ml, 100g" },
        { id: "features", label: "Features", type: "multiselect", options: ["Natural", "Organic", "Paraben-free", "SLS-free", "Vegan", "Alcohol-free"], fullWidth: true },
      ]},
    ],
    commonFields: [
      { id: "certification", label: "Certifications", type: "multiselect", options: ["FDA Approved", "Dermatologically Tested", "GMP Certified", "ISO Certified", "Cruelty-free", "Vegan", "Organic", "Halal"], fullWidth: true },
      { id: "shelfLife", label: "Shelf Life", type: "select", options: ["6 Months", "12 Months", "18 Months", "24 Months", "36 Months"] },
      { id: "packaging", label: "Packaging Type", type: "select", options: ["Tube", "Bottle", "Jar", "Pump", "Spray", "Stick", "Sachet", "Pouch", "Box"] },
    ],
  },
];
