...
export const sellerCategories: SellerCategory[] = [
  ...
  },
  {
    ...
    type: "product",
    subCategories: [
      { id: "skincare", name: "Skincare", fields: [
        { id: "productType", label: "Product Type", type: "select", options: ["Moisturizer", "Serum", "Cleanser", "Toner", "Sunscreen", "Face Mask", "Exfoliator", "Eye Cream", "Face Oil", "Lip Balm", "Night Cream", "Day Cream", "Face Mist", "Peel", "Spot Treatment", "Anti-aging Cream"], required: true },
        { id: "skinType", label: "Target Skin Type", type: "multiselect", options: ["All Skin Types", "Oily", "Dry", "Combination", "Sensitive", "Normal", "Acne-Prone", "Mature"], required: true, fullWidth: true },
        { id: "concerns", label: "Skin Concerns Addressed", type: "multiselect", options: ["Anti-aging", "Acne", "Pigmentation", "Dark Circles", "Dullness", "Pores", "Hydration", "Sun Protection", "Wrinkles", "Redness", "Dark Spots", "Uneven Tone", "Firmness"], fullWidth: true },
        { id: "keyIngredients", label: "Key Ingredients", type: "multiselect", options: ["Hyaluronic Acid", "Retinol", "Vitamin C", "Niacinamide", "Salicylic Acid", "AHA/BHA", "Aloe Vera", "Tea Tree", "Turmeric", "Saffron", "Glycolic Acid", "Ceramides", "Peptides", "Collagen", "Snail Mucin", "Centella Asiatica"], fullWidth: true },
        { id: "inciList", label: "INCI / Full Ingredient List", type: "textarea", placeholder: "Paste full INCI ingredient list", fullWidth: true },
        { id: "volume", label: "Volume / Weight", type: "text", placeholder: "e.g., 50ml, 100g", required: true },
        { id: "spf", label: "SPF (if applicable)", type: "select", options: ["None", "SPF 15", "SPF 30", "SPF 50", "SPF 50+"] },
        { id: "formulation", label: "Formulation", type: "select", options: ["Cream", "Gel", "Lotion", "Serum", "Oil", "Foam", "Mist", "Powder", "Sheet Mask", "Peel-off"] },
        { id: "fragrance", label: "Fragrance", type: "select", options: ["Fragrance-free", "Lightly Scented", "Scented"] },
      ]},
      { id: "makeup-face", name: "Face Makeup", fields: [
        { id: "productType", label: "Product Type", type: "select", options: ["Foundation", "Concealer", "Compact Powder", "Loose Powder", "Blush", "Bronzer", "Highlighter", "Primer", "Setting Spray", "BB Cream", "CC Cream", "Contour Kit", "Setting Powder"], required: true },
        { id: "finish", label: "Finish", type: "select", options: ["Matte", "Dewy", "Satin", "Natural", "Luminous", "Semi-Matte", "Radiant"], required: true },
        { id: "coverage", label: "Coverage", type: "select", options: ["Sheer", "Light", "Medium", "Full", "Buildable"] },
        { id: "formulation", label: "Formulation", type: "select", options: ["Liquid", "Cream", "Powder", "Stick", "Mousse", "Gel", "Cushion", "Whipped"] },
        { id: "shadeRange", label: "Shade Range", type: "text", placeholder: "e.g., 20 shades, Fair to Deep", required: true },
        { id: "skinType", label: "Best For Skin Type", type: "multiselect", options: ["All Skin Types", "Oily", "Dry", "Combination", "Sensitive"], fullWidth: true },
        { id: "inciList", label: "INCI / Full Ingredient List", type: "textarea", placeholder: "Paste full INCI ingredient list", fullWidth: true },
        { id: "volume", label: "Volume / Weight", type: "text", placeholder: "e.g., 30ml, 15g" },
        { id: "longevity", label: "Wear Time", type: "select", options: ["4-6 Hours", "6-8 Hours", "8-12 Hours", "12-16 Hours", "16+ Hours"] },
      ]},
      { id: "lip-products", name: "Lip Products", fields: [
        { id: "productType", label: "Product Type", type: "select", options: ["Lipstick", "Lip Gloss", "Lip Liner", "Lip Tint", "Lip Crayon", "Liquid Lipstick", "Lip Balm", "Lip Scrub", "Lip Stain", "Lip Oil", "Lip Plumper"], required: true },
        { id: "finish", label: "Finish", type: "select", options: ["Matte", "Glossy", "Satin", "Metallic", "Sheer", "Creamy", "Velvet", "Ombre"], required: true },
        { id: "shadeRange", label: "Shade Range", type: "text", placeholder: "e.g., 30 shades", required: true },
        { id: "longevity", label: "Longevity", type: "select", options: ["2-4 Hours", "4-6 Hours", "6-8 Hours", "8-12 Hours", "Transfer-proof"] },
        { id: "formulation", label: "Formulation", type: "select", options: ["Bullet", "Liquid", "Crayon", "Pencil", "Tube", "Pot"] },
        { id: "inciList", label: "INCI / Full Ingredient List", type: "textarea", placeholder: "Paste full INCI ingredient list", fullWidth: true },
        { id: "volume", label: "Weight / Volume", type: "text", placeholder: "e.g., 4.5g, 5ml" },
        { id: "features", label: "Features", type: "multiselect", options: ["Hydrating", "Long-lasting", "Vegan", "Cruelty-free", "Paraben-free", "Transfer-proof", "Smudge-proof", "Pigmented"], fullWidth: true },
      ]},
      { id: "eye-products", name: "Eye Makeup", fields: [
        { id: "productType", label: "Product Type", type: "select", options: ["Eyeshadow Palette", "Single Eyeshadow", "Eyeliner", "Kajal", "Kohl", "Mascara", "Eyebrow Pencil", "Eyebrow Gel", "False Lashes", "Eye Primer", "Lash Glue", "Under-eye Concealer"], required: true },
        { id: "finish", label: "Finish", type: "select", options: ["Matte", "Shimmer", "Glitter", "Metallic", "Satin", "Duo-chrome", "Creamy"] },
        { id: "shadeCount", label: "No. of Shades", type: "number", placeholder: "e.g., 12" },
        { id: "waterproof", label: "Waterproof", type: "select", options: ["Yes", "No", "Water-resistant"] },
        { id: "inciList", label: "INCI / Full Ingredient List", type: "textarea", placeholder: "Paste full INCI ingredient list", fullWidth: true },
        { id: "volume", label: "Weight / Volume", type: "text", placeholder: "e.g., 3g, 10ml" },
        { id: "features", label: "Features", type: "multiselect", options: ["Smudge-proof", "Long-lasting", "Cruelty-free", "Vegan", "Hypoallergenic", "Ophthalmologist Tested", "Pigmented"], fullWidth: true },
      ]},
      { id: "haircare", name: "Haircare", fields: [
        { id: "productType", label: "Product Type", type: "select", options: ["Shampoo", "Conditioner", "Hair Oil", "Hair Mask", "Hair Serum", "Leave-in Conditioner", "Dry Shampoo", "Hair Spray", "Heat Protectant", "Hair Color", "Hair Tonic", "Scalp Scrub", "Anti-dandruff Treatment"], required: true },
        { id: "hairType", label: "Target Hair Type", type: "multiselect", options: ["All Hair Types", "Straight", "Wavy", "Curly", "Coily", "Fine", "Thick", "Color-treated", "Chemically Treated"], required: true, fullWidth: true },
        { id: "concerns", label: "Hair Concerns", type: "multiselect", options: ["Hair Fall", "Dandruff", "Dryness", "Frizz", "Damage Repair", "Volume", "Growth", "Color Protection", "Split Ends", "Thinning", "Scalp Health", "Grey Coverage"], fullWidth: true },
        { id: "keyIngredients", label: "Key Ingredients", type: "multiselect", options: ["Keratin", "Argan Oil", "Biotin", "Coconut Oil", "Tea Tree", "Onion", "Bhringraj", "Amla", "Castor Oil", "Rice Water", "Hibiscus", "Caffeine"], fullWidth: true },
        { id: "inciList", label: "INCI / Full Ingredient List", type: "textarea", placeholder: "Paste full INCI ingredient list", fullWidth: true },
        { id: "volume", label: "Volume", type: "text", placeholder: "e.g., 200ml, 300ml", required: true },
        { id: "fragrance", label: "Fragrance", type: "text", placeholder: "e.g., Floral, Herbal, Unscented" },
      ]},
      { id: "nail-products", name: "Nail Products", fields: [
        { id: "productType", label: "Product Type", type: "select", options: ["Nail Polish", "Gel Polish", "Base Coat", "Top Coat", "Nail Art Kit", "Nail Extensions", "Press-on Nails", "Cuticle Oil", "Nail Remover", "Nail Strengthener", "Dip Powder"], required: true },
        { id: "finish", label: "Finish", type: "select", options: ["Glossy", "Matte", "Shimmer", "Glitter", "Metallic", "Chrome", "Holographic", "Cream"] },
        { id: "shadeRange", label: "Shade Range", type: "text", placeholder: "e.g., 50+ shades" },
        { id: "dryingTime", label: "Drying Time", type: "select", options: ["Quick Dry (60s)", "2-3 Minutes", "5+ Minutes", "UV/LED Cure"] },
        { id: "volume", label: "Volume", type: "text", placeholder: "e.g., 10ml, 15ml" },
        { id: "features", label: "Features", type: "multiselect", options: ["Chip-resistant", "Long-lasting", "Vegan", "Non-toxic", "5-Free", "7-Free", "10-Free", "Breathable", "Peel-off"], fullWidth: true },
      ]},
      { id: "fragrances", name: "Fragrances", fields: [
        { id: "productType", label: "Product Type", type: "select", options: ["Eau de Parfum", "Eau de Toilette", "Eau de Cologne", "Body Mist", "Perfume Oil", "Attar", "Deodorant", "Roll-on", "Solid Perfume"], required: true },
        { id: "fragranceFamily", label: "Fragrance Family", type: "select", options: ["Floral", "Woody", "Oriental", "Fresh", "Citrus", "Musky", "Gourmand", "Aquatic", "Amber", "Spicy", "Green", "Fruity"], required: true },
        { id: "topNotes", label: "Top Notes", type: "text", placeholder: "e.g., Bergamot, Lemon, Pink Pepper" },
        { id: "middleNotes", label: "Middle/Heart Notes", type: "text", placeholder: "e.g., Rose, Jasmine, Iris" },
        { id: "baseNotes", label: "Base Notes", type: "text", placeholder: "e.g., Sandalwood, Musk, Vanilla" },
        { id: "gender", label: "Gender", type: "select", options: ["Unisex", "Men", "Women"] },
        { id: "volume", label: "Volume", type: "text", placeholder: "e.g., 50ml, 100ml", required: true },
        { id: "longevity", label: "Longevity", type: "select", options: ["2-4 Hours", "4-6 Hours", "6-8 Hours", "8-12 Hours", "12+ Hours"] },
        { id: "sillage", label: "Sillage", type: "select", options: ["Intimate", "Moderate", "Strong", "Enormous"] },
        { id: "concentration", label: "Concentration %", type: "text", placeholder: "e.g., 15-20%" },
      ]},
      { id: "bath-body", name: "Bath & Body", fields: [
        { id: "productType", label: "Product Type", type: "select", options: ["Body Wash", "Body Lotion", "Body Butter", "Body Scrub", "Shower Gel", "Bath Bomb", "Hand Cream", "Body Oil", "Soap Bar", "Hand Wash", "Foot Cream", "Body Mist", "Deodorant", "Intimate Wash"], required: true },
        { id: "skinType", label: "Target Skin Type", type: "multiselect", options: ["All Skin Types", "Dry", "Oily", "Sensitive", "Normal", "Eczema-prone"], fullWidth: true },
        { id: "fragrance", label: "Fragrance", type: "text", placeholder: "e.g., Lavender, Rose, Unscented" },
        { id: "keyIngredients", label: "Key Ingredients", type: "multiselect", options: ["Shea Butter", "Cocoa Butter", "Coconut Oil", "Aloe Vera", "Honey", "Oatmeal", "Charcoal", "Tea Tree", "Glycerin"], fullWidth: true },
        { id: "inciList", label: "INCI / Full Ingredient List", type: "textarea", placeholder: "Paste full INCI ingredient list", fullWidth: true },
        { id: "volume", label: "Volume / Weight", type: "text", placeholder: "e.g., 250ml, 200g", required: true },
        { id: "features", label: "Features", type: "multiselect", options: ["Organic", "Vegan", "Paraben-free", "Sulphate-free", "Cruelty-free", "Handmade", "pH Balanced"], fullWidth: true },
      ]},
      { id: "beauty-tools", name: "Beauty Tools & Accessories", fields: [
        { id: "productType", label: "Product Type", type: "select", options: ["Makeup Brushes", "Brush Set", "Beauty Blender", "Sponge", "Eyelash Curler", "Tweezers", "Face Roller", "Gua Sha", "Derma Roller", "Mirror", "Makeup Organizer", "Brush Cleaner", "Puff", "Applicator"], required: true },
        { id: "material", label: "Material", type: "select", options: ["Synthetic", "Natural Hair", "Silicone", "Stainless Steel", "Jade", "Rose Quartz", "Plastic", "Wood", "Bamboo"] },
        { id: "setSize", label: "Set Size (if applicable)", type: "select", options: ["Single", "3-piece", "5-piece", "7-piece", "10-piece", "12-piece", "15+"] },
        { id: "features", label: "Features", type: "multiselect", options: ["Cruelty-free", "Vegan", "Travel-friendly", "Professional Grade", "Ergonomic", "Washable", "Reusable"], fullWidth: true },
      ]},
      { id: "mens-grooming", name: "Men's Grooming", fields: [
        { id: "productType", label: "Product Type", type: "select", options: ["Beard Oil", "Beard Balm", "Beard Wash", "Shaving Cream", "Shaving Foam", "After Shave", "Pre-Shave Oil", "Face Wash", "Hair Wax", "Hair Gel", "Hair Clay", "Pomade", "Grooming Kit", "Razor", "Trimmer Accessories"], required: true },
        { id: "skinType", label: "Skin Type", type: "multiselect", options: ["All Skin Types", "Oily", "Dry", "Sensitive", "Normal"], fullWidth: true },
        { id: "keyIngredients", label: "Key Ingredients", type: "multiselect", options: ["Charcoal", "Tea Tree", "Aloe Vera", "Jojoba Oil", "Argan Oil", "Menthol", "Vitamin E", "Caffeine"], fullWidth: true },
        { id: "inciList", label: "INCI / Full Ingredient List", type: "textarea", placeholder: "Paste full INCI ingredient list", fullWidth: true },
        { id: "volume", label: "Volume / Weight", type: "text", placeholder: "e.g., 50ml, 100g" },
        { id: "features", label: "Features", type: "multiselect", options: ["Natural", "Organic", "Paraben-free", "SLS-free", "Vegan", "Alcohol-free", "Dermatologist Tested"], fullWidth: true },
      ]},
      { id: "oral-care", name: "Oral Care", fields: [
        { id: "productType", label: "Product Type", type: "select", options: ["Toothpaste", "Mouthwash", "Teeth Whitening Kit", "Tongue Cleaner", "Tooth Powder", "Toothbrush", "Dental Floss", "Breath Freshener"], required: true },
        { id: "keyIngredients", label: "Key Ingredients", type: "multiselect", options: ["Fluoride", "Charcoal", "Neem", "Clove", "Baking Soda", "Aloe Vera", "Hydrogen Peroxide", "Xylitol"], fullWidth: true },
        { id: "inciList", label: "INCI / Full Ingredient List", type: "textarea", placeholder: "Paste full INCI ingredient list", fullWidth: true },
        { id: "volume", label: "Volume / Weight", type: "text", placeholder: "e.g., 100g, 250ml", required: true },
        { id: "features", label: "Features", type: "multiselect", options: ["Fluoride-free", "SLS-free", "Vegan", "Whitening", "Sensitivity Relief", "Herbal", "Charcoal-based"], fullWidth: true },
      ]},
      { id: "baby-kids-care", name: "Baby & Kids Care", fields: [
        { id: "productType", label: "Product Type", type: "select", options: ["Baby Shampoo", "Baby Lotion", "Baby Oil", "Baby Powder", "Diaper Cream", "Baby Wash", "Baby Sunscreen", "Baby Lip Balm", "Baby Soap"], required: true },
        { id: "ageGroup", label: "Age Group", type: "select", options: ["Newborn (0-3 months)", "Infant (3-12 months)", "Toddler (1-3 years)", "Kids (3-12 years)", "All Ages"] },
        { id: "keyIngredients", label: "Key Ingredients", type: "multiselect", options: ["Aloe Vera", "Calendula", "Chamomile", "Coconut Oil", "Shea Butter", "Oat Extract", "Vitamin E"], fullWidth: true },
        { id: "inciList", label: "INCI / Full Ingredient List", type: "textarea", placeholder: "Paste full INCI ingredient list", fullWidth: true },
        { id: "volume", label: "Volume / Weight", type: "text", placeholder: "e.g., 200ml, 100g", required: true },
        { id: "features", label: "Features", type: "multiselect", options: ["Pediatrician Tested", "Tear-free", "Hypoallergenic", "Paraben-free", "Sulphate-free", "Organic", "Fragrance-free", "pH Balanced"], fullWidth: true },
      ]},
      { id: "essential-oils-aromatherapy", name: "Essential Oils & Aromatherapy", fields: [
        { id: "productType", label: "Product Type", type: "select", options: ["Essential Oil", "Carrier Oil", "Blend Oil", "Diffuser Oil", "Roll-on Blend", "Aromatherapy Candle", "Incense", "Room Spray"], required: true },
        { id: "source", label: "Source / Plant", type: "text", placeholder: "e.g., Lavender, Eucalyptus, Peppermint", required: true },
        { id: "extractionMethod", label: "Extraction Method", type: "select", options: ["Steam Distillation", "Cold Pressed", "CO2 Extraction", "Solvent Extraction", "Enfleurage"] },
        { id: "purity", label: "Purity", type: "select", options: ["100% Pure", "Therapeutic Grade", "Organic", "Blend"] },
        { id: "volume", label: "Volume", type: "text", placeholder: "e.g., 15ml, 30ml, 100ml", required: true },
        { id: "usage", label: "Usage", type: "multiselect", options: ["Topical", "Aromatherapy", "Massage", "Hair Care", "Skin Care", "Bath", "Diffuser"], fullWidth: true },
      ]},
      { id: "sun-care", name: "Sun Care", fields: [
        { id: "productType", label: "Product Type", type: "select", options: ["Sunscreen", "After-Sun Lotion", "Tan Remover", "Self-tanning Lotion", "Sunscreen Spray", "Sunscreen Stick", "Sun Protection Lip Balm"], required: true },
        { id: "spf", label: "SPF", type: "select", options: ["SPF 15", "SPF 30", "SPF 40", "SPF 50", "SPF 50+", "SPF 100"], required: true },
        { id: "protection", label: "Protection Type", type: "select", options: ["UVA + UVB", "Broad Spectrum", "PA+++", "PA++++", "IR Protection"] },
        { id: "formulation", label: "Formulation", type: "select", options: ["Cream", "Gel", "Lotion", "Spray", "Stick", "Fluid", "Mousse"] },
        { id: "finish", label: "Finish", type: "select", options: ["Matte", "Dewy", "Invisible", "Tinted", "No White Cast"] },
        { id: "skinType", label: "Target Skin Type", type: "multiselect", options: ["All Skin Types", "Oily", "Dry", "Sensitive", "Acne-prone"], fullWidth: true },
        { id: "inciList", label: "INCI / Full Ingredient List", type: "textarea", placeholder: "Paste full INCI ingredient list", fullWidth: true },
        { id: "volume", label: "Volume", type: "text", placeholder: "e.g., 50ml, 100ml", required: true },
        { id: "waterResistant", label: "Water Resistant", type: "select", options: ["Yes", "No", "40 min", "80 min"] },
      ]},
    ],
    commonFields: [
      ...
      { id: "shelfLife", label: "Shelf Life", type: "select", options: ["6 Months", "12 Months", "18 Months", "24 Months", "36 Months"] },
      { id: "packaging", label: "Packaging Type", type: "select", options: ["Tube", "Bottle", "Jar", "Pump", "Spray", "Stick", "Sachet", "Pouch", "Box", "Dropper", "Airless Pump", "Roll-on", "Compact", "Pan"] },
      { id: "batchSize", label: "Minimum Batch Size", type: "text", placeholder: "e.g., 500 units, 1000 units" },
      { id: "sampleAvailable", label: "Sample Available?", type: "select", options: ["Yes (Free)", "Yes (Paid)", "No"] },
    ],
  },
];
