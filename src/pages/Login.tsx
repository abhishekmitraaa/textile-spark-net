  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-8">
        ...
        >
          {/* COSORA wordmark */}
          <h1 className="font-logo text-center text-4xl font-extrabold italic text-[#a4172c] uppercase tracking-tight mb-12">
            COSORA
          </h1>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 border border-gray-300 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
          >
