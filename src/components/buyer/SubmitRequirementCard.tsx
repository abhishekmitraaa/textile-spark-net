...
export default function SubmitRequirementCard({
  ...
  return (
    <div className={cn("relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-6 text-center", className)}>
      ...
      <Link to="/requirement/post-requirement" className="block">
        <motion.span
          ...
          className="block w-full rounded-xl bg-[#ef4d62] py-3 text-sm font-bold text-white transition-colors hover:bg-[#ef4d62]/90"
        >
      ...
      {onQuickRfq && (
        <div className="mt-4 border-t border-gray-100 pt-1 text-left">
